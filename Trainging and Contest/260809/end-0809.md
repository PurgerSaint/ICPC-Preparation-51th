> 比赛名称: 1116 Div.2
> 比赛时间: 2026/08/09 22:35-00:35
> 比赛结果: [Rank]9944 [Solved]1 [Rating-Change]-16 [New-Rating]879
# 2256A.Three Numbers on the Blackboard
[Rating]-
[Tag]数学、排序
[Time]-
## 题目详情
...
## 提交详情
- 提交时间:(比赛时)00:06:02 状态:AC 详细状态:`-`
> 我直接返回`a[1]`和`a[2]-a[0]`的最小值，此处数组`a`为三个数排序后的结果  
*赛后分析*  
对于排序后的 $a,b,c$ ，存在初始值`c-a`  
如果将 $a,c$ 结合代替 $b$ 可以得到 $a,c,a+c$ ，此时存在值 $(a+c)-a=c$ ，此值不比 $c-a$ 小  
如果将 $a,b$ 结合代替 $c$ 可以得到 $a,b,a+b$ ，此时存在值 $(a+b)-a=b$ ，此值有概率比 $c-a$ 小  
如果将 $b,c$ 结合代替 $a$ 可以得到 $b,c,b+c$ ，此时存在值 $(b+c)-b=c$ ，同一，此值不比 $c-a$ 小  
故答案仅存在于 $c-a$ 和 $b$ 二选一最小
